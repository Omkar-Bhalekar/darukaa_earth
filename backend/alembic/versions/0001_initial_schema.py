...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column(
            "geom", Geography(geometry_type="POLYGON", srid=4326), nullable=False
        ),
        sa.Column("area_hectares", sa.Float(), nullable=False),
        sa.Column("ecosystem_type", sa.String(100), nullable=False),
        sa.Column("monitoring_start_date", sa.Date(), nullable=False),
        sa.Column(
            "created_at", sa.DateTime(timezone=True), server_default=sa.text("now()")
        ),
    )
    op.create_table(
        ...
        sa.Column("carbon_tco2e", sa.Float()),
        sa.Column("biodiversity_index", sa.Float()),
    )
